...
public final class Property extends AbstractResource implements Comparable<Property> {
	...
	private List<URI> range = new ArrayList<URI>();
	...
	public String getAllowedValueURL(final String allowedValue) {
		...
		return allowedValues.get(allowedValue);
	}
	...
	@OslcReadOnly
	@OslcTitle("Allowed Values Reference")
...
//	@OslcValueType(ValueType.XMLLiteral)
	...
	public void setAllowedValues(Hashtable<String, String> enumeratedValuesHash) {
		allowedValues = enumeratedValuesHash;		
	}
}
